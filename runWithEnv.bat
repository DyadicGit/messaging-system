...
set VBOX_PATH=C:\PROGRA~1\Oracle\VirtualBox
%VBOX_PATH%\vboxmanage.exe startvm messaging-system --type emergencystop
%VBOX_PATH%\vboxmanage.exe sharedfolder add %VM_NAME% --name %NAME% --hostpath %HOSTPATH% --automount
%VBOX_PATH%\vboxmanage.exe sharedfolder remove %VM_NAME% --name c/Users
%VBOX_PATH%\vboxmanage.exe startvm messaging-system
TIMEOUT /T 50
